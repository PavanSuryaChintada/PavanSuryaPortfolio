    ...
    <div className="bg-gradient-content min-h-screen">
      <div className="px-6 py-6">
        ...
        <div className="space-y-4">
          <Link to="/projects" className="block bg-bg-card p-4 rounded-[6px] hover:bg-bg-card-hover transition-smooth cursor-pointer">
          ...
          <Link to="/skills" className="block bg-bg-card p-4 rounded-[6px] hover:bg-bg-card-hover transition-smooth cursor-pointer">
          ...
          <a href="https://github.com/PavanSuryaChintada" target="_blank" rel="noopener noreferrer" className="block bg-bg-card p-4 rounded-[6px] hover:bg-bg-card-hover transition-smooth cursor-pointer">
